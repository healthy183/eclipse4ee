		             ...
		             $.ligerDialog.open({ 
		            	 ...
		            	 buttons: [
			    					...
			    					if(isTrue){
			    						//alert(isTrue);
				    					///alert(usrNameVar);
				    					//usrNameVar = encodeURI(usrNameVar); //进行转码
				    					//usrPwdVar = encodeURI(usrPwdVar); //进行转码
				    					//alert(usrNameVar);
				    					$.post("${pageContext.request.contextPath}/main/isHadName/"+usrNameVar+".html",null,function(data){
				    					
				    						if(data == "true"){
				    							
				    							$.post("${pageContext.request.contextPath}/main/saveUsr/"+usrNameVar+"/"+usrPwdVar+".html",
				    									null,function(date){
